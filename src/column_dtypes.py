GAMES_BASIC = {'year': 'int', 'game_id': 'int', 'season': 'int', 'week': 'int', 'game_number': 'int',
...
PLAYER_COLUMNS['defence'] = {'game_id': 'int', 'abbreviation': 'string', 'team_id': 'int', 'tackles_total': 'int',
                             ...
                             'middle_name': 'string', 'last_name': 'string', 'birth_date': 'string'}
DRIVES_COLUMNS = {'year': 'int', 'game_id': 'int', 'play_id': 'int', 'play_sequence': 'int', 'entry': 'int',
...
EPA_COLUMNS = {'year': 'int', 'game_id': 'int', 'play_id': 'int', 'play_sequence': 'int', 'entry': 'int',
...
GEI_COLUMNS = {'year': 'int', 'game_id': 'int', 'gei': 'float', 'gsi': 'float', 'cbf': 'float', 'gei_pct': 'float',
