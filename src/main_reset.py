...
def main() -> None:
    ...
    years = download.download_games_basic(config.YEAR_START_GAMES, config.YEAR_END_GAMES, reset=True)
    ...
    game_ids = download.download_games_advanced(config.YEAR_START_ADV, config.YEAR_END_ADV, games, reset=True)
