...
def main() -> None:
    new_downloads = download.download_games_basic(config.YEAR_START_GAMES, config.YEAR_END_GAMES, reset=True)
    ...
    new_downloads = download.download_games_advanced(config.YEAR_START_ADV, config.YEAR_END_ADV, games, reset=True)
